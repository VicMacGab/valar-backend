...
body {font-family: 'Chivo', sans-serif;}
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center">Your two-factor authentication code is:</div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:18px 10px 18px 10px; line-height:32px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="font-size: 50px; color: #c20f0f">${code}</span></div><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;" valign="top" align="center">
          <img class="max-width" border="0" style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px; max-width:40% !important; width:40%; height:auto !important;" width="NaN" alt="" data-proportionally-constrained="true" data-responsive="true" src="http://cdn.mcauto-images-production.sendgrid.net/2c820caa83de75b4/09801198-7dee-45eb-9717-a1ccbe389821/614x791.png">
        </td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:40px 30px 40px 30px; line-height:22px; text-align:inherit; background-color:#9d1e1e;" height="100%" valign="top" bgcolor="#9d1e1e" role="module-content"><div><div style="font-family: inherit; text-align: center"><span style="color: #ffffff">This code will work for the next two minutes</span></div><div></div></div></td>
      </tr>
    </tbody>
